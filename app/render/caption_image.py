...
_FONT_STYLES: dict[str, dict] = {
    ...
    # ── PREMIUM SET (2026-07-22): modern, bold, and expensive-looking. Three earlier rounds
    # failed by reaching for either generic web-sans bolds or delicate fashion faces; these are
    # the design-studio releases (Fontshare / ITF free licence) that read premium at weight.
    # Treatment is deliberately shadow-only — a hard outline is what makes bold type read meme
    # rather than brand — with a touch of tracking and generous leading.
    ...
    "cabinet":    {"path": "fonts/CabinetGrotesk.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "satoshi":    {"path": "fonts/Satoshi.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "switzer":    {"path": "fonts/Switzer.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "excon":      {"path": "fonts/Excon.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 1, "case": None},
    "tanker":     {"path": "fonts/Tanker.ttf", "var": None, "size_mult": 0.74,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.46,
                   "tracking": 0, "case": None},
    "panchang":   {"path": "fonts/Panchang.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "zodiak":     {"path": "fonts/Zodiak.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "nippo":      {"path": "fonts/Nippo.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 1, "case": None},
    "generalsans": {"path": "fonts/GeneralSans.ttf", "var": None, "size_mult": 0.86,
                    "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                    "tracking": 0, "case": None},
    # kept: the wide grotesque that read closest in an earlier round
