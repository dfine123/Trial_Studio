...
_FONT_STYLES: dict[str, dict] = {
    ...
    # ── ELEVATED SET (2026-07-22): the brief is TASTE, not weight. Elegance here comes from
    # restraint — lighter faces, real letter-spacing, generous leading, a hairline outline for
    # legibility instead of a meme-caption slab. Sized well below the shout-y defaults.
    "tenor":      {"path": "fonts/TenorSans.ttf", "var": None, "size_mult": 0.66,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.62,
                   "tracking": 3, "case": "upper"},
    "italiana":   {"path": "fonts/Italiana.ttf", "var": None, "size_mult": 0.80,
                   "stroke": True, "stroke_frac": 0.028, "shadow": True, "spacing": 0.58,
                   "tracking": 4, "case": "upper"},
    "julius":     {"path": "fonts/JuliusSansOne.ttf", "var": None, "size_mult": 0.68,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.62,
                   "tracking": 4, "case": "upper"},
    "jost":       {"path": "fonts/Jost.ttf", "var": "Light", "size_mult": 0.78,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.50,
                   "tracking": 2, "case": None},
    "cormorant":  {"path": "fonts/Cormorant.ttf", "var": "Medium", "size_mult": 0.98,
                   "stroke": True, "stroke_frac": 0.028, "shadow": True, "spacing": 0.46,
                   "tracking": 1, "case": None},
    "prata":      {"path": "fonts/Prata.ttf", "var": None, "size_mult": 0.76,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.52,
                   "tracking": 1, "case": None},
    "marcellus":  {"path": "fonts/Marcellus.ttf", "var": None, "size_mult": 0.84,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.48,
                   "tracking": 2, "case": None},
    "poiret":     {"path": "fonts/PoiretOne.ttf", "var": None, "size_mult": 0.86,
                   "stroke": True, "stroke_frac": 0.028, "shadow": True, "spacing": 0.50,
                   "tracking": 3, "case": None},
    "bodoni":     {"path": "fonts/BodoniModa.ttf", "var": "SemiBold", "size_mult": 0.82,
                   "stroke": True, "stroke_frac": 0.030, "shadow": True, "spacing": 0.50,
                   "tracking": 1, "case": None},
    "questrial":  {"path": "fonts/Questrial.ttf", "var": None, "size_mult": 0.80,
                   "stroke": True, "stroke_frac": 0.032, "shadow": True, "spacing": 0.48,
                   "tracking": 2, "case": None},
    # kept from the last round — the wide grotesque was the one that read closest
    "expanded":   {"path": "fonts/ArchivoExp.ttf", "axes": [600, 125], "var": None,
                   "size_mult": 0.72, "stroke": True, "stroke_frac": 0.032, "shadow": True,
                   "spacing": 0.50, "tracking": 1, "case": None},
