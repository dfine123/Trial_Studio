...
_FONT_STYLES: dict[str, dict] = {
    ...
    # ── DISPLAY GROTESQUE SET (2026-07-22): the class the operator actually responded to —
    # Clash / Cabinet / Switzer are DISPLAY grotesques (tight apertures, drawn for large sizes),
    # not text sans and not novelty faces. Everything here is that species at its heaviest cut.
    # Shadow-only: a hard outline is what drags bold type back to meme.
    ...
    "switzer":    {"path": "fonts/Switzer.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "supreme":    {"path": "fonts/Supreme.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    ...
    "generalsans": {"path": "fonts/GeneralSans.ttf", "var": None, "size_mult": 0.86,
                    "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                    "tracking": 0, "case": None},
    "boldonse":   {"path": "fonts/Boldonse.ttf", "var": None, "size_mult": 0.68,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.52,
                   "tracking": 0, "case": None},
    "host":       {"path": "fonts/HostGrotesk.ttf", "var": "ExtraBold", "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "schibsted":  {"path": "fonts/SchibstedGrotesk.ttf", "var": "Black", "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "funnel":     {"path": "fonts/FunnelDisplay.ttf", "var": "ExtraBold", "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "instrument": {"path": "fonts/InstrumentSans.ttf", "axes": [700, 100], "var": None,
                   "size_mult": 0.88, "stroke": False, "stroke_frac": None, "shadow": True,
                   "spacing": 0.40, "tracking": 0, "case": None},
    "anybody":    {"path": "fonts/Anybody.ttf", "axes": [900, 130], "var": None,
