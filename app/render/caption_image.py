...
_FONT_STYLES: dict[str, dict] = {
    ...
    # ── PREMIUM SET v2 (2026-07-22): the operator warmed to Clash / Cabinet / Switzer and asked
    # for the same direction pushed further into character. These are the more stylised cuts on
    # the same shelf (Fontshare / ITF free licence). Shadow-only treatment throughout — a hard
    # outline is what drags bold type back to meme.
    "clash":      {"path": "fonts/ClashDisplay.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "cabinet":    {"path": "fonts/CabinetGrotesk.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "switzer":    {"path": "fonts/Switzer.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.40,
                   "tracking": 0, "case": None},
    "technor":    {"path": "fonts/Technor.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "array":      {"path": "fonts/Array.ttf", "var": None, "size_mult": 0.76,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.46,
                   "tracking": 1, "case": "upper"},
    "bespoke":    {"path": "fonts/BespokeSans.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "chubbo":     {"path": "fonts/Chubbo.ttf", "var": None, "size_mult": 0.84,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "ranade":     {"path": "fonts/Ranade.ttf", "var": None, "size_mult": 0.88,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "amulya":     {"path": "fonts/Amulya.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "bonny":      {"path": "fonts/Bonny.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "quilon":     {"path": "fonts/Quilon.ttf", "var": None, "size_mult": 0.86,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.42,
                   "tracking": 0, "case": None},
    "stardom":    {"path": "fonts/Stardom.ttf", "var": None, "size_mult": 0.90,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.44,
                   "tracking": 1, "case": None},
    "kola":       {"path": "fonts/Kola.ttf", "var": None, "size_mult": 0.78,
                   "stroke": False, "stroke_frac": None, "shadow": True, "spacing": 0.46,
                   "tracking": 0, "case": None},
    "expanded":   {"path": "fonts/ArchivoExp.ttf", "axes": [700, 125], "var": None,
                   "size_mult": 0.74, "stroke": False, "stroke_frac": None, "shadow": True,
                   "spacing": 0.46, "tracking": 0, "case": None},
