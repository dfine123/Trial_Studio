...
And it can't just be a wise thought in casual words — that's a poster, and he scrolls posters. There has to be something that clicks: a picture he can see, a number that does the work, a fact about a kind of man that says everything without explaining anything. He should get a little "damn" when it lands, and he should get it himself — the line never explains what it means, never adds the lesson at the end, never points at its own irony.
